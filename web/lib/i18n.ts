...
export const MESSAGES: Record<LangCode, Dict> = {
  zh: {
    siteName: "Xixun News", metaDescription: "AI 新闻与行业动态",
    ...
    noContent: "该频道暂无内容 —— 运行 npm run ingest 抓取内容源。",
    noBody: "本文暂无正文内容。",
  ...
  tw: {
    siteName: "Xixun News", metaDescription: "AI 新聞與產業動態",
    ...
    noContent: "該頻道暫無內容 —— 執行 npm run ingest 抓取內容源。",
    noBody: "本文暫無正文內容。",
  ...
  en: {
    siteName: "Xixun News", metaDescription: "AI news and industry updates",
    ...
    noContent: "Nothing here yet — run npm run ingest to pull from your feeds.",
  ...
  ja: {
    siteName: "Xixun News", metaDescription: "AIニュースと業界動向",
    ...
    noContent: "このチャンネルにはまだ記事がありません。npm run ingest を実行してください。",
    noBody: "本文はありません。",
